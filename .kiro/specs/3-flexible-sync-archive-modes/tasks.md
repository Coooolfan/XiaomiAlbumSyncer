...
- [x] 1. 扩展数据模型和枚举类型
  ...
  - [ ] 1.2 扩展 ArchiveMode 枚举类
    - 在现有的 TIME 和 SPACE 基础上添加 DISABLED 枚举值
    - 添加中文注释说明
    - _需求：2.2_
  
  - [ ] 1.3 扩展 CrontabConfig 数据类
...
- [ ] 4. 增强 ArchiveService 实现
  - [ ] 4.1 修改 previewArchive 方法
    - 添加 archiveMode 判断
    - DISABLED 模式：返回空计划
    - 其他模式：按原有逻辑执行
    - _需求：2.5_
  
  - [ ] 4.2 修改 executeArchive 方法
    - 添加 archiveMode 判断
...
- [ ] 5. 实现配置迁移服务
  - [ ] 5.1 创建 ConfigMigrationService 类
